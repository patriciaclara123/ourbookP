...
import com.example.ourbook1.databinding.ActivityUpdateBinding
        ...
        binding.editButton.setOnClickListener {
            ...
            when {
                ...
                !emailPattern.matches(newEmail) -> {
                    ...
                    val updateBook = Book(bookId, newName, newSurename, newEmail, newAddress, newDate, newHP, db.ImageViewToByte(binding.editPhoto))
