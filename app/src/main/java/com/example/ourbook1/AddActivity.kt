...
class AddActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.doneButton.setOnClickListener {
            ...
            val surename = binding.addNP.text.toString()
            ...
            val hp = binding.addHP.text.toString()
            ...
            when {
                ...
                !emailPattern.matches(email) -> {
                    ...
                    val book = Book(0, name, surename, email, address, date, hp, db.ImageViewToByte(binding.addPhoto))
                    db.insertBook(book)
